...
```
>💡反思：<br>
>現代資訊太過發達，這些套件的使用網路上大多能找到範本，甚至說Copilot可以直接代勞不少部分，<br>
>甚至機器學習演算法也是套件做好不用自己手刻，補充點統計知識就能駕馭<br>
>...所以重點好像也不是工具的使用，應該要結合特定領域的知識－<br>
>不過如果不立志當資料科學家，只是工程師，側重點本來就會有差異..？<br>
>不過因為會寫後端，所以對於程式面的例外debug反射速度是非常快的..<br>
>試著想想要如何對這些資料產生創見呢？<-可以看看吳恩達的免費課程 AI101 或許有甚麼靈感？
